...
async function startBot() {
  ...
  sock.ev.on("messages.upsert", async ({ messages }) => {
    ...
    // اگر ویدئو داشتیم (فعلاً پشتیبانی نمی‌شه)
      ...
      reply = "🎥 متأسفم، تحلیل ویدئو فعلاً پشتیبانی نمی‌شود. لطفاً تصویر یا متن ارسال کنید.";
    }
    // پیام متنی
    else if (text.trim()) {
      ...
      reply = "🤖 متوجه نشدم. لطفاً پیام یا تصویر ارسال کنید.";
    }
